    ...
    <li className="px-3 py-3 flex items-start">
      ...
      <div className="flex-grow">
        <div className="flex items-center">
          <span className="flex-none font-medium text-2xl text-blue-500">Company Name: {companyDetail.companyName}</span>
          <span className="flex-grow text-right">{companyDetail.companyStartDate}</span>
        </div>
