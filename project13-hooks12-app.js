...
const App = () => {
  ...
  return (
    <div className="App" style={{background: "lightyellow", height: "100vh"}}>
      <img src="https://skillsdynamix.com/wp-content/uploads/2020/06/reactjsh.jpg" style={{width: "350px", height: "150px", border: "5px solid crimson", borderStyle: "double"}} alt="stellie" />
